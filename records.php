...
<header class="w3-container color1 w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">Your Records</h1><i onclick="location.href='report.php';" class="fa fa-file-export fa-4x w3-margin-right w3-hover-text-black" title="Generate a report" style="cursor: pointer;"></i>
</header>
